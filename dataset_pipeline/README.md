...
| Face ROI size        | 256×256 color     | (not specified)   |
| Landmark features    | mouth+face coords | (not specified)   |
...
python 03_extract_visual_features.py --input_dir data/segments/ --output_dir data/lip_rois/ --detector pytorch
...
### Step 3: Lip ROI Extraction (`03_extract_visual_features.py`)
